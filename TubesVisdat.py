...
aces1 = fig1.line('Date', 'Open', legend_label='ACES', color='red',line_width=2, source=data_source_aces)
adro1 = fig1.line('Date', 'Open', legend_label='ADRO', color='yellow',line_width=2, source=data_source_adro)
akra1 = fig1.line('Date', 'Open', legend_label='AKRA', color='green',line_width=2, source=data_source_akra)
antm1 = fig1.line('Date', 'Open', legend_label='ANTM', color='blue',line_width=2, source=data_source_antm)
...
fig1.add_tools(HoverTool(renderers=[aces1],tooltips=tooltips,formatters=formatters))
fig1.add_tools(HoverTool(renderers=[adro1],tooltips=tooltips,formatters=formatters))  
fig1.add_tools(HoverTool(renderers=[akra1],tooltips=tooltips,formatters=formatters)) 
fig1.add_tools(HoverTool(renderers=[antm1],tooltips=tooltips,formatters=formatters)) 

fig1.legend.location = 'top_right'
fig1.legend.click_policy='hide'

layout1 = row(fig1,widgetbox(pickeraces1,pickeradro1,pickerakra1,pickerantm1))
...
select1.line('Date','Low',color='yellow',line_width=2,source=data_source_adro)
select1.line('Date','Low',color='green',line_width=2,source=data_source_akra)
select1.line('Date','Low',color='blue',line_width=2,source=data_source_antm)
...
aces2 = fig2.line('Date', 'High', legend_label='ACES', color='red',line_width=2, source=data_source_aces)
adro2 = fig2.line('Date', 'High', legend_label='ADRO', color='yellow',line_width=2, source=data_source_adro)
akra2 = fig2.line('Date', 'High', legend_label='AKRA', color='green',line_width=2, source=data_source_akra)
antm2 = fig2.line('Date', 'High', legend_label='ANTM', color='blue',line_width=2, source=data_source_antm)
...
fig2.add_tools(HoverTool(renderers=[aces2],tooltips=tooltips,formatters=formatters))
fig2.add_tools(HoverTool(renderers=[adro2],tooltips=tooltips,formatters=formatters))  
fig2.add_tools(HoverTool(renderers=[akra2],tooltips=tooltips,formatters=formatters)) 
fig2.add_tools(HoverTool(renderers=[antm2],tooltips=tooltips,formatters=formatters)) 

fig2.legend.location = 'top_right'
fig2.legend.click_policy='hide'

layout2 = row(fig2,widgetbox(pickeraces2,pickeradro2,pickerakra2,pickerantm2))
...
select2.line('Date','Low',color='yellow',line_width=2,source=data_source_adro)
select2.line('Date','Low',color='green',line_width=2,source=data_source_akra)
select2.line('Date','Low',color='blue',line_width=2,source=data_source_antm)
...
aces3 = fig3.line('Date', 'Low', legend_label='ACES', color='red',line_width=2, source=data_source_aces)
adro3 = fig3.line('Date', 'Low', legend_label='ADRO', color='yellow',line_width=2, source=data_source_adro)
akra3 = fig3.line('Date', 'Low', legend_label='AKRA', color='green',line_width=2, source=data_source_akra)
antm3 = fig3.line('Date', 'Low', legend_label='ANTM', color='blue',line_width=2, source=data_source_antm)
...
fig3.add_tools(HoverTool(renderers=[aces3],tooltips=tooltips,formatters=formatters))
fig3.add_tools(HoverTool(renderers=[adro3],tooltips=tooltips,formatters=formatters))  
fig3.add_tools(HoverTool(renderers=[akra3],tooltips=tooltips,formatters=formatters)) 
fig3.add_tools(HoverTool(renderers=[antm3],tooltips=tooltips,formatters=formatters)) 

fig3.legend.location = 'top_right'
fig3.legend.click_policy='hide'

layout3 = row(fig3,widgetbox(pickeraces3,pickeradro3,pickerakra3,pickerantm3))
...
select3.line('Date','Low',color='yellow',line_width=2,source=data_source_adro)
select3.line('Date','Low',color='green',line_width=2,source=data_source_akra)
select3.line('Date','Low',color='blue',line_width=2,source=data_source_antm)
...
aces4 = fig4.line('Date', 'Close', legend_label='ACES', color='red',line_width=2, source=data_source_aces)
adro4 = fig4.line('Date', 'Close', legend_label='ADRO', color='yellow',line_width=2, source=data_source_adro)
akra4 = fig4.line('Date', 'Close', legend_label='AKRA', color='green',line_width=2, source=data_source_akra)
antm4 = fig4.line('Date', 'Close', legend_label='ANTM', color='blue',line_width=2, source=data_source_antm)
...
fig4.add_tools(HoverTool(renderers=[aces4],tooltips=tooltips,formatters=formatters))
fig4.add_tools(HoverTool(renderers=[adro4],tooltips=tooltips,formatters=formatters))  
fig4.add_tools(HoverTool(renderers=[akra4],tooltips=tooltips,formatters=formatters)) 
fig4.add_tools(HoverTool(renderers=[antm4],tooltips=tooltips,formatters=formatters)) 

fig4.legend.location = 'top_right'
fig4.legend.click_policy='hide'

layout4 = row(fig4,widgetbox(pickeraces4,pickeradro4,pickerakra4,pickerantm4))
...
select4.line('Date','Close',color='red',line_width=2,source=data_source_aces)
select4.line('Date','Close',color='yellow',line_width=2,source=data_source_adro)
select4.line('Date','Close',color='green',line_width=2,source=data_source_akra)
select4.line('Date','Close',color='blue',line_width=2,source=data_source_antm)
...
aces5 = fig5.line('Date', 'Volume', legend_label='ACES', color='red',line_width=2, source=data_source_aces)
adro5 = fig5.line('Date', 'Volume', legend_label='ADRO', color='yellow',line_width=2, source=data_source_adro)
akra5 = fig5.line('Date', 'Volume', legend_label='AKRA', color='green',line_width=2, source=data_source_akra)
antm5 = fig5.line('Date', 'Volume', legend_label='ANTM', color='blue',line_width=2, source=data_source_antm)
...
fig5.add_tools(HoverTool(renderers=[aces5],tooltips=tooltips,formatters=formatters))
fig5.add_tools(HoverTool(renderers=[adro5],tooltips=tooltips,formatters=formatters))  
fig5.add_tools(HoverTool(renderers=[akra5],tooltips=tooltips,formatters=formatters)) 
fig5.add_tools(HoverTool(renderers=[antm5],tooltips=tooltips,formatters=formatters)) 

fig5.legend.location = 'top_right'
fig5.legend.click_policy='hide'

layout5 = row(fig5,widgetbox(pickeraces5,pickeradro5,pickerakra5,pickerantm5))
...
select5.line('Date','Volume',color='red',line_width=2,source=data_source_aces)
select5.line('Date','Volume',color='yellow',line_width=2,source=data_source_adro)
select5.line('Date','Volume',color='green',line_width=2,source=data_source_akra)
select5.line('Date','Volume',color='blue',line_width=2,source=data_source_antm)
